...
class Client extends Runtime\Client\Client
{
     ...
     *
     * @return ($fetch is 'object' ? Model\Pet|null : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? Model\Order|null : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch  Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? Model\User|null : \Psr\Http\Message\ResponseInterface)
     */
